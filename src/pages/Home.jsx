        ...
        <>
            ...
            <div className="container">
                ...
                <div className="sliderCatagoryBtn flex flex-col lg:flex-row">
                    ...
                    <div className="directBtnRight bg-[#ededed] mt-1 lg:mt-0 lg:w-[35%] flex justify-center  items-center  lg:py-2">
                ...
                <div className="homeElement bg-purple-400 ">
                    <Link href="/">
                        <div>
                            <strong className="inline "> Event T-shirt <IoIosArrowForward /> </strong> 
                            <span className="flex">T-shirt/Clothing with your brand logo or design? We are delivering worldwide at unbeatable prices. <strong> Click here  <FaArrowCircleRight /> </strong>  </span>
                        </div>
