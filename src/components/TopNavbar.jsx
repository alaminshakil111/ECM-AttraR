        ...
        <div className="wrapper">
          <div className="flex items-center justify-between py-1">
            ...
            <div className="topNavRight w-7/12 flex justify-end items-center space-x-4 text-[#fff] text-xl ">
              ...
              <div className= {`loginChoosebox bg-slate-900 absolute top-8 z-10 flex flex-col gap-1 px-2 py-2
              ${isLogin ? "block" : "hidden" }` }>
                <div className="loginOpenBtn leading-[1] pb-1">
                    <a href="/" className=" text-sm hover:text-[#b6b5b5] flex flex-col "> Login 
                      <span className="text-[12px] text-[#777575] "> Enter your account </span>
                    </a>
                    
                </div>
                <div className="registerOpenBtn leading-[1] pb-1">
                  <a href="/" className=" text-sm hover:text-[#b6b5b5] flex flex-col "> Register 
                    <span className="text-[12px] text-[#777575]"> Creat an account </span>
                  </a>
                </div>
                <div className="helpbtn leading-[1] pb-1">
                  <a href="/" className=" text-sm hover:text-[#b6b5b5] flex flex-col "> Help 
